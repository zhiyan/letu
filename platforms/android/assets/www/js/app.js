...
.run(function($ionicPlatform,$ionicPopup,$rootScope) {
  ...
  $ionicPlatform.registerBackButtonAction(function(e) {
    ...
    if ($rootScope.$viewHistory.backView
        && $rootScope.$viewHistory.currentView.stateId !== "signin"
        && $rootScope.$viewHistory.currentView.stateId !== "regiter"
        && $rootScope.$viewHistory.currentView.stateId !== "success"
        && $rootScope.$viewHistory.currentView.stateId !== "tab.dash") {
      // Go back in history
